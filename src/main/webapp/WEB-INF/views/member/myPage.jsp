   ...
   * div{
    ...
    * a{
    ...
    #content-center-empty-top-area2{
     ...
     #content-confirm-area{/*꿈나무 카드 등록공간*/
         width: 100%;
         height: 400PX;
         float: left;
        ...
        <div id="content-center">
            ...
            <div id="content-center-info-area">
                ...
                <div id="info-info-area">
                        ...
                        <br><br><hr>    
                        <div class="data-title">비밀번호</div><div class="info-data"><span>${sessionScope.member.userPwd }</span></div>
                        <br><br><hr>
