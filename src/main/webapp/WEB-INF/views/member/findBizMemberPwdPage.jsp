...
<body>
	<div id="wrap">
		...
		<div id="content">
			...
			<div class="contents_wrap">
				...
				<form id="findInfoForm" action="/member/findBizMemberPwd.do" method="post" onsubmit="return check();">
					<label for="userId">아이디</label><br/>
					<input class="findInfoInput" type="text" id="bizId" name="bizId" placeholder="아이디를 입력해 주세요"><br/>
	...
	$('#findMemberPwdBtn').click(function(){
		...
		$.ajax({
			url: "/member/findBizMemberPwd.do",
			data: {"bizId":bizId, "bizEmail":bizEmail},
			type: "post",
				...
				}else
				{
					Swal.fire({
						  ...
						  text: '아이디와 이메일 정보를 확인해주세요.'
							...
							location.href='/member/findBizMemberPwdPage.do';
						});
